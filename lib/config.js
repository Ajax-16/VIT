...
export function loadVitConfig() {
    ...
    try {
        ...
        // Merge types: los custom reemplazan los default por value
        ...
        if (Array.isArray(parsed.types) && parsed.types.length > 0) {
            ...
            // Mantener orden: primero los que existían en orden, luego nuevos al final
            ...
            mergedTypes = [...ordered, ...newOnes.map((t) => ({
                value: t.value,
